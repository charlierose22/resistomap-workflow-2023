...
flags_removed$row = NULL
flags_removed$column = NULL
flags_removed$conc = NULL
...
# Remove the id column, as it has been replaced.
mutated_id$id = NULL
mutated_id$replicate = NULL
...
delta_ct_asp_sum <- as.data.frame(colSums(delta_ct_asp_rownames[ , -1], 
                                          na.rm = TRUE))
